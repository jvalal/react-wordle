...
export const StatsModal = ({
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        className="mr-10 mt-2 w-1/3 rounded-md border border-transparent px-2 py-2 bg-sky-600 text-xl font-medium text-white hover:bg-sky-700 focus:outline-none focus:ring-0 focus:ring-offset-1 focus:ring-sky-500 sm:text-xl"
        onClick={() => {
